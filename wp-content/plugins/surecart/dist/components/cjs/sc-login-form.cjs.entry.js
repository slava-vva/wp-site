...
const ScLogin = class {
    ...
    render() {
        var _a, _b;
        return (index.h("div", { key: '57e42b0b4666bbe2959aeef18e815e54588a7d39', class: "login-form" }, index.h("sc-card", { key: 'bb7600556bfe5066ac72142704f529d3b1bd4966' }, !!this.error && (index.h("sc-alert", { key: '3ab4c1070dc84ad1d994a8f0d5b5fd423ea2e8e5', open: true, type: "danger", closable: true, onScHide: () => (this.error = null) }, index.h("span", { key: 'f3ab839d1f152d147c678bacb37386d9c3271f24', slot: "title", innerHTML: (_a = this.error) === null || _a === void 0 ? void 0 : _a.message }), (((_b = this.error) === null || _b === void 0 ? void 0 : _b.additional_errors) || []).map(({ message }) => (index.h("div", { innerHTML: message }))))), this.renderInner()), this.loading && index.h("sc-block-ui", { key: 'dc75c88c3581e6c038bac162a6215b48c606170c', spinner: true, style: { 'zIndex': '9', '--sc-block-ui-opacity': '0.5' } })));
    }
