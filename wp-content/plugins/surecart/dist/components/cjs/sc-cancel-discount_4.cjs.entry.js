...
const ScCancelDiscount = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '2836993f49100ad158fe23739c75e252839a0034', class: "cancel-discount" }, index.h("sc-dashboard-module", { key: 'd8e320da87981a18f6e12272db46006fb9b97c42', heading: title, style: { '--sc-dashboard-module-spacing': '2em' } }, index.h("span", { key: '275ae94536469a1d664188f5b1a7ec94369b8a33', slot: "description" }, description), index.h("sc-flex", { key: '8aa1e7b8583e0f996aa3d82608525d09137cafd1', justifyContent: "flex-start" }, index.h("sc-button", { key: '02759ab32116fe780c40c90e495f407da927bc16', type: "primary", onClick: () => this.addDiscount() }, button), index.h("sc-button", { key: 'c2204761b9c23ac6da352ba77b20abc929b40d7c', class: "cancel-discount__abort-link", type: "text", onClick: () => this.scCancel.emit() }, cancel_link)), !!this.loading && index.h("sc-block-ui", { key: '9ff04555386452e97f71138f44d5ad8063f7815c', spinner: true }))));
    }
};
...
const ScSubscriptionCancel = class {
    ...
    render() {
        return (index.h("sc-dashboard-module", { key: '634bb1799cd5f920b8b43974e5f614777f2132de', heading: this.heading || wp.i18n.__('Cancel your plan', 'surecart'), class: "subscription-cancel", error: this.error, style: { '--sc-dashboard-module-spacing': '1em' } }, this.renderContent(), index.h("sc-flex", { key: '58fd5f46c3b3cf92c43ad76a2b2f1fb4bc444afa', justifyContent: "flex-start" }, index.h("sc-button", { key: '75af5cd43997cfe31d3a7081cc3f07b41d2561a8', type: "primary", loading: this.loading || this.busy, disabled: this.loading || this.busy, onClick: () => this.cancelSubscription() }, wp.i18n.__('Cancel Plan', 'surecart')), index.h("sc-button", { key: '4324910e48c5d1bd793e15562761750e9919f458', style: { color: 'var(--sc-color-gray-500' }, type: "text", onClick: () => this.scAbandon.emit(), loading: this.loading || this.busy, disabled: this.loading || this.busy }, wp.i18n.__('Keep My Plan', 'surecart'))), this.busy && index.h("sc-block-ui", { key: 'f44936af897737c33a148ff5de14a22d2657d5d5' })));
    }
};
...
const ScTextarea = class {
    ...
    render() {
        var _a;
        return (index.h("div", { key: '574885b3edc91930d1b7757f042cc2680fb728b1', part: "form-control", class: {
                'form-control': true,
                'form-control--small': this.size === 'small',
                'form-control--medium': this.size === 'medium',
                'form-control--large': this.size === 'large',
            } }, index.h("sc-form-control", { key: 'ef76e51d8785c5aa79e878ad46449415501c9e3e', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, index.h("div", { key: 'd6c5e2aea1f8bffefcc888f1b03232c55ea84385', part: "form-control-input", class: "form-control-input" }, index.h("div", { key: '476e73e7f5cb4e70956e5074eedf67f5ce28ffc8', part: "base", class: {
                'textarea': true,
