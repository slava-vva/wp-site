...
const ScPaymentMethodsList = class {
    ...
    render() {
        return (index.h("sc-dashboard-module", { key: 'cd8b3279018d01a3f619c92f49a9222e73aacc11', class: "payment-methods-list", error: this.error }, index.h("span", { key: '9a2b8133a9b26e0472cd923d6d11ce74f5cdba7c', slot: "heading" }, index.h("slot", { key: 'bf215e895d9ed7cbf800da8aa6031d55a1e4c5f2', name: "heading" }, this.heading || wp.i18n.__('Payment Methods', 'surecart'))), this.isCustomer && (index.h("sc-flex", { key: '7e04f6ea07470eac74fe6f9e83f8c9ca247e578e', slot: "end" }, index.h("sc-button", { key: 'eae8ccbb73275ce14e5f8e39510e9c37f14f7d89', type: "link", href: addQueryArgs.addQueryArgs(window.location.href, {
                action: 'index',
                model: 'charge',
            }) }, index.h("sc-icon", { key: '2865398ea0cf2a6440ee556f5ea68575d8f43517', name: "clock", slot: "prefix" }), wp.i18n.__('Payment History', 'surecart')), index.h("sc-button", { key: 'ae935722ac3c2dfed9321af4f20cbf9f4ca76c02', type: "link", href: addQueryArgs.addQueryArgs(window.location.href, {
                action: 'create',
                model: 'payment_method',
            }) }, index.h("sc-icon", { key: 'd6a610d6f2abd11a548909902bed9c57241fd2e0', name: "plus", slot: "prefix" }), wp.i18n.__('Add', 'surecart')))), this.renderContent(), index.h("sc-dialog", { key: 'edf15fa53daa4e9fc1c5b164712ed3ef5100dbd0', open: !!this.editPaymentMethod, label: wp.i18n.__('Update Default Payment Method', 'surecart'), onScRequestClose: () => (this.editPaymentMethod = false) }, index.h("sc-alert", { key: 'dbff7bc5e6e5f7801f738c420380af8dacf2229e', type: "danger", open: !!this.error }, this.error), index.h("sc-flex", { key: '87c678aa0156c9b2c4aa602a4844691995b5950d', flexDirection: "column", style: { '--sc-flex-column-gap': 'var(--sc-spacing-small)' } }, index.h("sc-alert", { key: '0170c2f2cf02125b9fbacb69cce5c4f638189bf2', type: "info", open: true }, wp.i18n.__('A default payment method will be used as a fallback in case other payment methods get removed from a subscription.', 'surecart')), index.h("sc-switch", { key: 'ac65dd035baff8d7947d5ceae1bd47404d8b51cd', checked: this.cascadeDefaultPaymentMethod, onScChange: e => (this.cascadeDefaultPaymentMethod = e.target.checked) }, wp.i18n.__('Update All Subscriptions', 'surecart'), index.h("span", { key: '4740f486fc7f0b9091a8b450a400fb333bda623d', slot: "description" }, wp.i18n.__('Update all existing subscriptions to use this payment method', 'surecart')))), index.h("div", { key: '0cd2d1c844c80ebac20f73c490ce1a90c34da70e', slot: "footer" }, index.h("sc-button", { key: 'a439cdf578c1a828a9403315bcc7186b9eece498', type: "text", onClick: () => (this.editPaymentMethod = false) }, wp.i18n.__('Cancel', 'surecart')), index.h("sc-button", { key: 'ce249fe690f5a871dee222e8693dd23cf3f78db0', type: "primary", onClick: () => this.setDefault() }, wp.i18n.__('Make Default', 'surecart'))), this.busy && index.h("sc-block-ui", { key: '7b242b13aeae5c675f47a1a88a9da0920939dd23', spinner: true })), index.h("sc-dialog", { key: '08fefd5c9a38aa8f69418910c6711cf8ed4c616d', open: !!this.deletePaymentMethod, label: wp.i18n.__('Delete Payment Method', 'surecart'), onScRequestClose: () => (this.deletePaymentMethod = false) }, index.h("sc-alert", { key: '2603a6ca5d9d9a25d5ab79dda54e7b6799c78813', type: "danger", open: !!this.error }, this.error), index.h("sc-text", { key: 'ef922dafb8c15d47a8ee84f962957064ab027bf6' }, wp.i18n.__('Are you sure you want to remove this payment method?', 'surecart')), index.h("div", { key: '99e5bfdc1d1f3ccbc0c2fde5c0ef4414092021d0', slot: "footer" }, index.h("sc-button", { key: '585d7601568485f59dfb46a0304cba3439c949ef', type: "text", onClick: () => (this.deletePaymentMethod = false) }, wp.i18n.__('Cancel', 'surecart')), index.h("sc-button", { key: '517bf0767e8218ee057f72dace55d055bafb7d33', type: "primary", onClick: () => this.deleteMethod() }, wp.i18n.__('Delete', 'surecart'))), this.busy && index.h("sc-block-ui", { key: 'b4de4df8fbb4dbfeba4ff800e45c91f9230ee851', spinner: true })), this.busy && index.h("sc-block-ui", { key: '3ba74aa0620ef77e748089d8b5f6e43d0b8881db', spinner: true })));
    }
