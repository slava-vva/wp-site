...
const ScLineItemShipping = class {
    ...
    render() {
        ...
        return (index.h("sc-line-item", null, index.h("span", { slot: "description" }, this.label || wp.i18n.__('Shipping', 'surecart')), index.h("span", { slot: "price" }, checkout === null || checkout === void 0 ? void 0 : checkout.shipping_display_amount)));
    }
};
...
const ScRadio = class {
    ...
    render() {
        ...
        return (index.h(Tag, { key: '6d9fbebc4d1f8f411e5d38132257839321cec89f', part: "base", class: {
                'radio': true,
                'radio--checked': this.checked,
                'radio--disabled': this.disabled,
                'radio--focused': this.hasFocus,
                'radio--editing': this.edit,
            }, htmlFor: this.inputId, onKeyDown: e => this.handleKeyDown(e), onMouseDown: e => this.handleMouseDown(e) }, index.h("span", { key: 'c3a44da6d6cb1d64bb3fe2da3612d64673fa51fd', part: "control", class: "radio__control" }, index.h("span", { key: 'd1020885bfc75cc66e515635f4ba92cd401ffc43', part: "checked-icon", class: "radio__icon" }, index.h("svg", { key: '884b3aafc82a37c1bd1639a5860554d41dbde6a1', viewBox: "0 0 16 16" }, index.h("g", { key: 'a0a8b589612a8f660c6f6fe1f200d16b45d1d824', stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd" }, index.h("g", { key: 'b07f3cab6d19acf9e0ed6f052425913ead813218', fill: "currentColor" }, index.h("circle", { key: '1285f4072c59a95724ffdf407f4222bab61b55fd', cx: "8", cy: "8", r: "3.42857143" }))))), index.h("input", { key: 'b41108222732c19d863807d02b3894d3b0019b19', id: this.inputId, ref: el => (this.input = el), type: "radio", name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, required: this.required, "aria-checked": this.checked ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', "aria-labelledby": this.labelId, onClick: () => this.handleClick(), onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus() })), index.h("span", { key: '1cc0fe0c2dccfb419d4d8274e583fc7d7d59bd44', part: "label", id: this.labelId, class: "radio__label" }, index.h("slot", { key: 'b090257652dce8d306d9b389279daccd935b4ab3' }), index.h("slot", { key: 'd75b5c1043cffc7eac6d185b291d35dd4a0df679', name: "description" }))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const ScRadioGroup = class {
    ...
    render() {
        return (index.h("fieldset", { key: '198bb8228c63fcb964e857c8b2332ae0f4174e29', part: "base", class: {
                'radio-group': true,
                'radio-group--invalid': this.invalid,
                'radio-group--is-required': this.required,
                'radio-group--is-rtl': pageAlign.isRtl(),
            }, "aria-invalid": this.invalid, role: "radiogroup" }, index.h("legend", { key: '42221d8cd5b3e9868eec9fa02598e7d5fb759cf2', part: "label", class: "radio-group__label" }, index.h("slot", { key: '48fa58053def1fd2ae396c307cf74e0cae6abe50', name: "label" }, this.label)), index.h("input", { key: '7e455b247f5620f7881da2296e601119a01eafe3', type: "text", class: "radio-group__hidden-input", ref: el => (this.input = el), required: this.required, value: this.value, tabindex: "-1" }), index.h("div", { key: '44e6618e1cdb006c058dddde26afb8bfa1fba4e8', part: "items", class: "radio-group__items" }, index.h("slot", { key: '03abbcbd134035a308cfd7b202b29aee7ec86179' }))));
    }
    get el() { return index.getElement(this); }
};
