...
const ScInvoicesList = class {
    ...
    render() {
        var _a, _b;
        return (index.h("sc-dashboard-module", { key: '798ce604d127fd18b0404df9cf84b8438fb55f7d', class: "invoices-list", error: this.error }, index.h("span", { key: 'bcf991cc7fef319bbf151e54bf6c3ede9fa8c5d0', slot: "heading" }, index.h("slot", { key: '2322dda77fb0430a7350a7f9ea27974e5504ec29', name: "heading" }, this.heading || wp.i18n.__('Invoices', 'surecart'))), !!this.allLink && !!((_a = this.invoices) === null || _a === void 0 ? void 0 : _a.length) && (index.h("sc-button", { key: 'bc64d73c93193c042db4d2caa6fdf2a993919a9b', type: "link", href: this.allLink, slot: "end", "aria-label": wp.i18n.sprintf(wp.i18n.__('View all %s', 'surecart'), this.heading || wp.i18n.__('Invoices', 'surecart')) }, wp.i18n.__('View all', 'surecart'), index.h("sc-icon", { key: 'cb42cb21b25e868c7374956f0d28d9966df97fd1', "aria-hidden": "true", name: "chevron-right", slot: "suffix" }))), this.renderContent(), !this.allLink && (index.h("sc-pagination", { key: 'ae3775a273bf76ea73bf002ffad9d8b8902fea0a', page: this.query.page, perPage: this.query.per_page, total: this.pagination.total, totalPages: this.pagination.total_pages, totalShowing: (_b = this === null || this === void 0 ? void 0 : this.invoices) === null || _b === void 0 ? void 0 : _b.length, onScNextPage: () => this.nextPage(), onScPrevPage: () => this.prevPage() })), this.busy && index.h("sc-block-ui", { key: '733716e7cf095f7412ed6f5710d70476d948b2d1' })));
    }
