...
const ScDownloadsList = class {
    ...
    render() {
        var _a;
        return (index.h("sc-purchase-downloads-list", { key: 'e92fc4dfc5d7d64b7b8fa6f5313d4bbec68ec952', heading: this.heading, allLink: this.allLink && this.pagination.total_pages > 1 ? this.allLink : '', loading: this.loading, busy: this.busy, requestNonce: this.requestNonce, error: this.error, purchases: this.purchases }, index.h("span", { key: 'b084ae3d8b4f160f69b85af444a07dea8f23ea16', slot: "heading" }, index.h("slot", { key: 'f950ea34f3f079e310ba433ad1f99f7adb808435', name: "heading" }, this.heading || wp.i18n.__('Downloads', 'surecart'))), index.h("sc-pagination", { key: '2ced9d46edf5480141be7679007c3804000652d1', slot: "after", page: this.query.page, perPage: this.query.per_page, total: this.pagination.total, totalPages: this.pagination.total_pages, totalShowing: (_a = this === null || this === void 0 ? void 0 : this.purchases) === null || _a === void 0 ? void 0 : _a.length, onScNextPage: () => this.nextPage(), onScPrevPage: () => this.prevPage() })));
    }
