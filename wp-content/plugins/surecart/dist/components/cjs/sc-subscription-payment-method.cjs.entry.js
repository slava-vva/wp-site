...
const ScSubscriptionPaymentMethodStyle0 = scSubscriptionPaymentMethodCss;
...
const ScSubscriptionPaymentMethod = class {
    ...
    render() {
        var _a;
        return (index.h("sc-dashboard-module", { key: '68f4fcb3fa41930b31b4eca3e20f36ea56923607', heading: this.heading || wp.i18n.__('Update Payment Method', 'surecart'), class: "subscription", error: this.error }, index.h("sc-button", { key: 'd1d64a29aabf443a4fb56f843d4ad52c43355f67', slot: "end", type: "link", href: addQueryArgs.addQueryArgs(window.location.href, {
                action: 'create',
                model: 'payment_method',
                ...(((_a = this.subscription) === null || _a === void 0 ? void 0 : _a.live_mode) === false ? { live_mode: false } : {}),
                success_url: window.location.href,
            }) }, index.h("sc-icon", { key: '1c90c6664d0d8e9a3e04b9f7d03146088dd3e851', name: "plus", slot: "prefix" }), wp.i18n.__('Add New', 'surecart')), this.renderContent(), this.busy && index.h("sc-block-ui", { key: 'a6572fdf665ee0604ceb8da0e2cf1f69e3fefbb5', spinner: true })));
    }
    get el() { return index.getElement(this); }
};
ScSubscriptionPaymentMethod.style = ScSubscriptionPaymentMethodStyle0;
