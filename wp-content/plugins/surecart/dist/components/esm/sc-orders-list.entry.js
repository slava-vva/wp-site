...
const ScOrdersList = class {
    ...
    render() {
        var _a, _b;
        return (h("sc-dashboard-module", { key: '172b41d98777c3f70af94847126ca1850f004911', class: "orders-list", error: this.error }, h("span", { key: '6fd963821e2327924090294265c75e35b5b2635d', slot: "heading" }, h("slot", { key: 'd7dda6282c315d5db271928c3a181cdc0c869d87', name: "heading" }, this.heading || wp.i18n.__('Order History', 'surecart'))), !!this.allLink && !!((_a = this.orders) === null || _a === void 0 ? void 0 : _a.length) && (h("sc-button", { key: '9979cda7b3b8c9d45bce06d3bfb20c87b5a5b580', type: "link", href: this.allLink, slot: "end", "aria-label": wp.i18n.sprintf(wp.i18n.__('View all %s', 'surecart'), this.heading || wp.i18n.__('Order History', 'surecart')) }, wp.i18n.__('View all', 'surecart'), h("sc-icon", { key: 'afef09b4cb120343b4767148bfdcd3d2761e95a7', "aria-hidden": "true", name: "chevron-right", slot: "suffix" }))), this.renderContent(), !this.allLink && (h("sc-pagination", { key: '9a26e9638a118ef3e485be9d2a227065cdfa0b57', page: this.query.page, perPage: this.query.per_page, total: this.pagination.total, totalPages: this.pagination.total_pages, totalShowing: (_b = this === null || this === void 0 ? void 0 : this.orders) === null || _b === void 0 ? void 0 : _b.length, onScNextPage: () => this.nextPage(), onScPrevPage: () => this.prevPage() })), this.busy && h("sc-block-ui", { key: '6e3cf425dda02b9ad304d4f04cefc642487f52f1' })));
    }
