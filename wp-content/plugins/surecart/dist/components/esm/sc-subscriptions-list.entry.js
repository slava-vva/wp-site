...
const ScSubscriptionsList = class {
    ...
    render() {
        var _a, _b;
        return (h("sc-dashboard-module", { key: '3edef38c7bb435cff304bbf2c102c4ab86d2c729', class: "subscriptions-list", error: this.error }, h("span", { key: '7f05c96aab0d032b0ab18053e1ea575c6ac38e64', slot: "heading" }, h("slot", { key: 'f0cbe407d0a0095d08a704b68226bbd95e9c1dd1', name: "heading" }, this.heading || wp.i18n.__('Subscriptions', 'surecart'))), !!this.allLink && !!((_a = this.subscriptions) === null || _a === void 0 ? void 0 : _a.length) && (h("sc-button", { key: '62673507f2a02f88d1a592a2f7b654d5459c2989', type: "link", href: this.allLink, slot: "end", "aria-label": wp.i18n.sprintf(wp.i18n.__('View all %s', 'surecart'), this.heading || 'Subscriptions') }, wp.i18n.__('View all', 'surecart'), h("sc-icon", { key: '4d87a03e88e2630ced452a01713a90aa137bdf54', "aria-hidden": "true", name: "chevron-right", slot: "suffix" }))), this.renderContent(), !this.allLink && (h("sc-pagination", { key: '16fdb18ba37125b12ef42ceba31986a1047c6d1e', page: this.query.page, perPage: this.query.per_page, total: this.pagination.total, totalPages: this.pagination.total_pages, totalShowing: (_b = this === null || this === void 0 ? void 0 : this.subscriptions) === null || _b === void 0 ? void 0 : _b.length, onScNextPage: () => this.nextPage(), onScPrevPage: () => this.prevPage() })), this.busy && h("sc-block-ui", { key: '67088752538e626fb33688ef10a38d7be6f97c37' })));
    }
