...
const ScRichText = class {
    ...
    render() {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        return (h(Host, { key: '1502f61c74a235b700738198947bb1f1fcc3a2d7' }, h("sc-form-control", { key: '4a91ae418eee441f179ad96862c301dd2d99b027', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, h("div", { key: 'b7852b025cc3dceaeff5b1976fbc30a5dd8d7bfc', part: "base", class: { 'editor-base': true, 'editor--focused': this.hasFocus } }, h("div", { key: 'e44acfd542a4e3bb865e6259a67f4991a219ad17', class: "menu" }, h("sc-button", { key: 'acba5c7b3a4a3936b3b0bc7d933c4b41f8fdbe4b', size: "small", type: ((_b = (_a = this.editor) === null || _a === void 0 ? void 0 : _a.isActive) === null || _b === void 0 ? void 0 : _b.call(_a, 'bold')) ? 'default' : 'text', onClick: () => this.run('toggleBold'), disabled: !this.can('toggleBold') }, h("sc-icon", { key: '0a5769de7884c9a8e9c8fd04c3d98222888247d4', name: "bold" })), h("sc-button", { key: '33849d3a4ae6fd108e8cde701e462019fceae4c2', size: "small", type: ((_d = (_c = this.editor) === null || _c === void 0 ? void 0 : _c.isActive) === null || _d === void 0 ? void 0 : _d.call(_c, 'italic')) ? 'default' : 'text', onClick: () => this.run('toggleItalic'), disabled: !this.can('toggleItalic') }, h("sc-icon", { key: '07975c07663a327e0cdb7cbd5ce1c443d2b08430', name: "italic" })), h("sc-button", { key: '356c7b0d26b2543ff2576ffbe0b3d27da218f0bf', size: "small", type: ((_f = (_e = this.editor) === null || _e === void 0 ? void 0 : _e.isActive) === null || _f === void 0 ? void 0 : _f.call(_e, 'bulletList')) ? 'default' : 'text', onClick: () => this.run('toggleBulletList') }, h("sc-icon", { key: '3174d28a175f006fb84e47c3c6efb1dec2765a37', name: "list" })), h("sc-button", { key: 'bc774c1bf8f96f882ed72f382d9e160b912edf70', size: "small", type: ((_h = (_g = this.editor) === null || _g === void 0 ? void 0 : _g.isActive) === null || _h === void 0 ? void 0 : _h.call(_g, 'strike')) ? 'default' : 'text', onClick: () => this.run('toggleStrike') }, h("sc-icon", { key: '4f07ce4b7e324a9b79fe11b5ac8db93219906f90', name: "minus" })), h("sc-button", { key: '657a1b79d088d79a00b6d7545f136417589d4bf1', class: "right", size: "small", type: "text", onClick: () => this.run('undo'), disabled: !this.can('undo') }, h("sc-icon", { key: '3372a462df046ab418ccedb4d820362cc1932c77', name: "corner-up-left" })), h("sc-button", { key: '4203776abc9e0b7baa39b0c1348558a2588dab2d', size: "small", type: "text", onClick: () => this.run('redo'), disabled: !this.can('redo') }, h("sc-icon", { key: '4dc7669e49fd6efdd78de6950015b38d90322a66', name: "corner-up-right" }))), h("div", { key: '9a2efd36dcb3f84cf15cb9c737ec33b2cbefcf8e', part: "editor", class: {
                editor: true,
            }, ref: el => (this.element = el) })), this.remainingCharacters() < 20 && h("div", { key: 'ccaa002f4ee3abee57ecf2f906a3ed0fcfffd504', class: 'textarea__char-limit-warning' }, wp.i18n.sprintf(wp.i18n.__('%d characters remaining', 'surecart'), this.remainingCharacters())))));
    }
};
