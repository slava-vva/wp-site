import { r as registerInstance, h, c as createEvent, a as getElement } from './index-745b6bec.js';
import { F as FormSubmitController } from './form-data-76641f16.js';
import { b as isValidURL } from './util-50af2a83.js';
...
const ScSelectDropdown = class {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.scSearch = createEvent(this, "scSearch", 7);
        this.scOpen = createEvent(this, "scOpen", 7);
        ...
        this.scScrollEnd = createEvent(this, "scScrollEnd", 7);
    ...
    renderIcon(icon) {
        if (isValidURL(icon)) {
            return h("img", { src: icon, alt: "icon", slot: "prefix", class: "choice__icon--image" });
        }
        return h("sc-icon", { name: icon, slot: "prefix", class: "choice__icon" });
    }
    renderItem(choice, index) {
        var _a;
        const uniqueKey = `${(choice === null || choice === void 0 ? void 0 : choice.value) || (choice === null || choice === void 0 ? void 0 : choice.label) || 'item'}-${index}`;
        if ((_a = choice === null || choice === void 0 ? void 0 : choice.choices) === null || _a === void 0 ? void 0 : _a.length) {
            return h("sc-menu-label", { key: uniqueKey }, choice === null || choice === void 0 ? void 0 : choice.label);
        }
        return (h("sc-menu-item", { class: { 'is-unavailable': choice === null || choice === void 0 ? void 0 : choice.unavailable }, key: uniqueKey, checked: this.isChecked(choice), value: choice === null || choice === void 0 ? void 0 : choice.value, onClick: () => !choice.disabled && this.handleSelect(choice), onKeyDown: event => {
                if ((event.key === 'Enter' || event.key === ' ') && !choice.disabled) {
                    event.preventDefault();
                    event.stopImmediatePropagation();
                    this.handleSelect(choice);
                }
            }, disabled: choice.disabled, "aria-label": choice.label, "aria-selected": this.isChecked(choice) ? 'true' : 'false', role: "option" }, choice.label, !!(choice === null || choice === void 0 ? void 0 : choice.description) && h("div", { class: "select__description" }, choice === null || choice === void 0 ? void 0 : choice.description), h("div", { slot: "suffix" }, choice === null || choice === void 0 ? void 0 :
            choice.suffix, " ", !!(choice === null || choice === void 0 ? void 0 : choice.suffixDescription) && h("div", { class: "select__suffix-description" }, choice === null || choice === void 0 ? void 0 : choice.suffixDescription)), !!(choice === null || choice === void 0 ? void 0 : choice.icon) && this.renderIcon(choice.icon)));
    }
    render() {
        var _a;
        return (h("div", { key: 'a4993fd218d0193909fe2bd65db8308983176ba7', part: "base", class: {
                'select': true,
            ...
            } }, h("sc-form-control", { key: '21a57df9f1cc6399489c994c5592e6b3773260d1', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, h("input", { key: '337baf4363a9e2932bcaf81143b847e14cdf5fe5', class: "select__hidden-input", name: this.name, ref: el => (this.input = el), value: this.value, required: this.required, disabled: this.disabled, "aria-hidden": "true", "aria-label": this.displayValue() || this.label || this.placeholder, onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus() }), h("sc-dropdown", { key: 'e31f1946298f424ad5b38ddda76a609f2f076633', exportparts: "trigger, panel", disabled: this.disabled, open: this.open, closeOnSelect: this.closeOnSelect, position: this.position, placement: this.placement, hoist: this.hoist, style: { '--panel-width': '100%' }, onScShow: () => this.handleShow(), onScHide: () => this.handleHide(), role: "select", "aria-open": this.open ? 'true' : 'false' }, h("slot", { key: 'f84c0f75261986cbd4dc8f0b293a4cc3e911f7f5', name: "trigger", slot: "trigger" }, h("div", { key: '1e860b4aa980e8cbd6189bf63bf74de6ff2874f2', class: "trigger", role: "button", tabIndex: -1, onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() }, h("div", { key: '62e09e1ff38beaa8e616fd09f6c995cdb9da0100', class: "select__value" }, h("slot", { key: 'bc8974c094e9da4a09da71e99b3f980d4f8f0287' }, this.displayValue() || this.placeholder || wp.i18n.__('Select...', 'surecart'))), h("sc-icon", { key: '67d0bf9ab2e1238048d78b0bdd2419fd35c0317f', exportparts: "base:caret", class: "select__caret", name: "chevron-down" }))), this.search && (h("sc-input", { key: '152d622b5dd74d021aa9ed5d9e1b8190322add70', exportparts: "base:search__base, input:search__input, form-control:search__form-control", placeholder: this.searchPlaceholder || wp.i18n.__('Search...', 'surecart'), onScInput: e => this.handleQuery(e), class: "search", clearable: true, part: "search", value: this.searchTerm, ref: el => (this.searchInput = el), "aria-label": wp.i18n.__('Type to search', 'surecart') }, this.loading && h("sc-spinner", { key: 'c363a3b79c849ff8b9eda8d5176b507473adf31d', exportparts: "base:spinner__base", style: { '--spinner-size': '0.5em' }, slot: "suffix" }))), h("sc-menu", { key: 'd52161be75b7bd7146d9419c842b58c8eac89325', style: { maxHeight: '210px', overflow: 'auto' }, exportparts: "base:menu__base", onScroll: e => this.handleMenuScroll(e), "aria-multiselectable": "false" }, h("slot", { key: '2a35640b6bef16f3e22826c5397d3cb0bea7697e', name: "prefix" }), (this.filteredChoices || []).map((choice, index) => {
            return [this.renderItem(choice, index), (choice.choices || []).map(choice => this.renderItem(choice, index))];
        }), this.loading && (h("div", { key: '269bed9855efce110f43f5e66f284ab9a6007c9b', class: "loading" }, h("sc-spinner", { key: '21a1201d392d539485ec673337b34831cdcd7295', exportparts: "base:spinner__base" }))), !this.loading && !this.filteredChoices.length && (h("div", { key: 'cc35d20f0204cb97fc6e21b52a2dbbd1415f97ba', class: "select__empty", part: "empty" }, wp.i18n.__('Nothing Found', 'surecart'))), h("slot", { key: '2f375247bac6be94eab8ccf8e5b2ce7e16cb59de', name: "suffix" }))))));
    }
...
export { ScMenuLabel as sc_menu_label, ScSelectDropdown as sc_select };

//# sourceMappingURL=sc-menu-label_2.entry.js.map